...
def kNNPrediction(k, X_train, X_test, t_train):
    ...
    for x_test in X_test:
        ...
        # EuDistance = np.linalg.norm(x_test - X_train, axis = 1)

        # Sort data points by distance and get first K numbers of nearest neighbors
...
def main():
    ...
    for k in kVal: 
        predict_kNN = kNNPrediction(k, x_train, x_test, t_train)
